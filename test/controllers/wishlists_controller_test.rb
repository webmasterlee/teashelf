...
class WishlistsControllerTest < ActionController::TestCase
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post :create, wishlist: { name: @wishlist.name, notes: @wishlist.notes, url: @wishlist.url, user_id: @wishlist.user_id }
    end
  ...
  test "should update wishlist" do
    patch :update, id: @wishlist, wishlist: { name: @wishlist.name, notes: @wishlist.notes, url: @wishlist.url, user_id: @wishlist.user_id }
    assert_redirected_to wishlist_path(assigns(:wishlist))
  end
